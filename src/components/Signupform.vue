...
<form id="signup-form" v-on:submit.prevent="submit">
    <mdb-card-title class="mt-4 h2"><center>CONTACT US</center></mdb-card-title>
    <div class="row">
        <div class="col-12 form-group">
            <label class="col-form-label col-form-label-lg">Full Name <span class="text-danger"></span></label>
            <input type="text" v-model.trim="$v.fullname.$model" :class="{'is-invalid': validationStatus($v.fullname)}" class="form-control form-control-lg" placeholder="Your name..">
        ...
        <div class="col-12 form-group">
            ...
            <input type="email" v-model.trim="email" :class="{'is-invalid': validationStatus($v.email)}" class="form-control form-control-lg" placeholder="email..">
        ...
        <!--<div class="col-12 form-group">
            ...
            <div v-if="!$v.password.minLength" class="invalid-feedback">You must have atleast {{ $v.password.$params.minLength.min}} letters.</div>
        ...
        <div class="col-12 form-group">
            ...
            <input type="number" v-model.trim="phonenumber"  :class="{'is-invalid': validationStatus($v.phonenumber)}" class="form-control form-control-lg" placeholder="contact no..">
            <div v-if="!$v.phonenumber.required" class="invalid-feedback">The phonenumber field is required.</div>
        </div>

        <div class="col-12 form-group">
            <label class="col-form-label col-form-label-lg">Message<span class="text-danger"></span></label>
            <input type="text" v-model.trim="message"   :class="{'is-invalid': validationStatus($v.message)}" class="form-control form-control-lg" placeholder="write..">
